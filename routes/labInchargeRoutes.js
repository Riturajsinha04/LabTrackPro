...
router.all('/dashboard', labInchargeController.getDashboard);
router.all('/requests', labInchargeController.getPendingRequests);
...
router.all('/issued-items', labInchargeController.getIssuedItems);
